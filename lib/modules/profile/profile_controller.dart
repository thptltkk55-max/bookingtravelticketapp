...
class ProfileController extends GetxController {
  ...
  Future<String> uploadImageToStorage(String childName, Uint8List file) async {
    ...
    return homeController.userModel.value?.imgAvatar?.isNotEmpty == true
  ...
  Future<void> createUser(UserModel userModel) async {
    try {
      ...
      debugPrint('[ProfileController] Created userModel profile: '
          'docId=${docRef.id}, email=${userModel.email}');
      Get.snackbar(
      ...
      debugPrint('[ProfileController] Failed to create userModel profile: '
          '$error');
  ...
  Future<void> createPushNotification(String idUser, String fcmToken) async {
    try {
      ...
      debugPrint('[ProfileController] Created pushNotification: '
          'docId=${docRef.id}, idUser=$idUser');
      Get.snackbar(
        StringConst.success.tr,
      ...
      debugPrint('[ProfileController] Failed to create pushNotification: '
          '$error');
      debugPrintStack(stackTrace: stackTrace);
      Get.snackbar(
        StringConst.error.tr,
